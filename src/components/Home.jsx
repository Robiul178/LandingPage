...
export default function Home() {
  return (
    <main>
      <section className="bg-gradient-to-br from-blue-100 to-white h-full flex items-center justify-center pt-10 lg:pb-52 ">
      ...
      <section className="bg-blue-800 py-12 max-sm:p-4 lg:p-0 lg:py-12 md:p-4">
